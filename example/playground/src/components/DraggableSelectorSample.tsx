...
export default function DraggableSelectorSample({
  mode,
  slotWidth = 62,
  slotHeight = 18,
  slotsMarginTop = 11,
  ...
  /*
   * The mode of selector. Assign the value in `day` | `date`. e.g. `day`, `date`
   */
  mode: 'day' | 'date';
  /*
    ...
    <OuterContainer>
      ...
      <ControlContainer>
        <TitleContainer>
          ...
          <Mode>{'(not provided components )'}</Mode>
        </TitleContainer>
...
const ComponentTitle = styled.h1`
  ...
  font-weight: 600;
  font-family: 'SBAggroB', sans-serif;
  background-color: rgba(96, 220, 160, 0.35);
`;
...
const Announce = styled.h1`
  font-size: 18px;
  font-weight: 600;
  font-family: 'NanumSquareNeo-Variable', sans-serif;
  background-color: rgba(255, 107, 220, 0.23);
`;
