import{j as t}from"./jsx-runtime-4ca860c5.js";import{r as o}from"./index-61bf1805.js";import{n as a,D as W,T as A,a as Y,C as R}from"./index-78f95b87.js";import"./_commonjsHelpers-de833af9.js";import"./extends-35d9a1b8.js";function r({slotWidth:n=62,slotHeight:g=18,slotsMarginTop:x=11,slotsMarginLeft:h=20,maxWidth:S="546px",maxHeight:F="452px",defaultSlotColor:C="#FFFFFF",selectedSlotColor:y="#b3c6d3",disabledSlotColor:D="#e1e1e1",hoveredSlotColor:M="#eef2f6",slotsContainerBorder:v="1px solid #8c8d94",slotsContainerBorderRadius:b="0px",dateFormat:T="MM.DD",timeFormat:H="HH:mm A"}){const e=new Date,[s,j]=o.useState("11:00"),[i,q]=o.useState("19:00"),[d,w]=o.useState(30),[m,B]=o.useState([new Date(e.getFullYear(),e.getMonth(),e.getDate()),new Date(e.getFullYear(),e.getMonth(),e.getDate()+1),new Date(e.getFullYear(),e.getMonth(),e.getDate()+2),new Date(e.getFullYear(),e.getMonth(),e.getDate()+3),new Date(e.getFullYear(),e.getMonth(),e.getDate()+4),new Date(e.getFullYear(),e.getMonth(),e.getDate()+5)]),[V,_]=o.useState([]);return t.jsxs(E,{children:[t.jsxs(L,{children:[t.jsx(p,{children:t.jsx(U,{children:"* DraggableSelector"})}),t.jsx(W,{dates:m,minTime:Number(s.split(":")[0]),maxTime:Number(i.split(":")[0]),timeSlots:V,setTimeSlots:_,mode:"date",timeUnit:d,dateFormat:T,timeFormat:H,slotWidth:n,slotHeight:g,slotsMarginTop:x,slotsMarginLeft:h,maxWidth:S,maxHeight:F,defaultSlotColor:C,selectedSlotColor:y,disabledSlotColor:D,hoveredSlotColor:M,slotsContainerBorder:v,slotsContainerBorderRadius:b})]}),t.jsxs(N,{children:[t.jsxs(p,{children:[t.jsx(k,{children:"* Control Ex."}),t.jsx(z,{children:"(not provided)"})]}),t.jsx(A,{timeUnit:d,setTimeUnit:w}),t.jsx(Y,{maxTime:i,minTime:s,setMaxTime:q,setMinTime:j}),t.jsx(R,{dates:m,setDates:B})]})]})}const E=a.div`
  display: flex;
...
//# sourceMappingURL=DateMode.stories-1e0a9857.js.map
